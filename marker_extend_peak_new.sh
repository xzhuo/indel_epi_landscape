...
python3 ~/github/indel_epi_landscape/crossmap_parser.py -i hg38_crossmap_panTro5_bothway.${m}.lite.strand.bed > hg38_crossmap_panTro5.${m}.filter.bed
...
# run crossmap parser and filter:
python3 ~/github/indel_epi_landscape/crossmap_parser.py -i panTro5_crossmap_hg38_bothway.${m}.lite.strand.bed > panTro5_crossmap_hg38.${m}.filter.bed
